...
try:
    ...
    Kronos = KronosTokenizer = KronosPredictor = None  # type: ignore[assignment]
...
class KronosPredictorUtility:
    ...
    def __init__(self, device: Optional[str] = None):
        ...
        if torch is None or SentenceTransformer is None or Kronos is None or KronosTokenizer is None or KronosPredictor is None:
            logger.warning("⚠️ Kronos optional dependencies are missing; predictor disabled.")
