...
metadata: {"clawdbot":{"requires":{"env":["SUPABASE_URL"]}}}
---
...
| SUPABASE_SERVICE_KEY | One of three | Service role key (full access) |
| SUPABASE_SECRET_KEY | One of three | Alternate OpenClaw secret key name |
| SUPABASE_SERVICE_ROLE_KEY | One of three | Alternate service role key name |
...
- The helper accepts `SUPABASE_SERVICE_KEY`, `SUPABASE_SECRET_KEY`, or `SUPABASE_SERVICE_ROLE_KEY`
