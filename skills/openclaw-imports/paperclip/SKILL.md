...
PAPERCLIP_API_KEY: loaded from ~/.openclaw/workspace/paperclip-claimed-api-key.json → token field
PAPERCLIP_API_KEY_FILE: ~/.openclaw/workspace/paperclip-claimed-api-key.json
